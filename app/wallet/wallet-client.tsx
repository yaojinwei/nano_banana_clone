  ...
  return (
    <div className="min-h-screen bg-background pt-16">
      <div className="container mx-auto max-w-6xl px-4 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-3">My Wallet</h1>
          <p className="text-lg text-muted-foreground">View your balance and recharge records</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer" onClick={handleRecharge}>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Recharge</h3>
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer" onClick={handleViewRechargeRecords}>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Recharge History</h3>
                <p className="text-sm text-muted-foreground">View historical recharge records</p>
              </div>
            </div>
          </Card>
        </div>
